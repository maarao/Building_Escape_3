...
Building_Escape_3RootPath=/mnt/Game_Drive/Unreal/UnrealProjects/Building_Escape_3
...
include(Building_Escape_3Source.pri)
include(Building_Escape_3Header.pri)
include(Building_Escape_3Config.pri)
include(Building_Escape_3Includes.pri)
include(Building_Escape_3Defines.pri)
...
EpicWebHelper-Linux-Debug.commands = $$build EpicWebHelper Linux Debug  $$args
EpicWebHelper-Linux-DebugGame.commands = $$build EpicWebHelper Linux DebugGame  $$args
EpicWebHelper-Linux-Shipping.commands = $$build EpicWebHelper Linux Shipping  $$args
EpicWebHelper-Linux-Test.commands = $$build EpicWebHelper Linux Test  $$args
EpicWebHelper.commands = $$build EpicWebHelper Linux Development  $$args
...
InterchangeWorker-Linux-Debug.commands = $$build InterchangeWorker Linux Debug  $$args
InterchangeWorker-Linux-DebugGame.commands = $$build InterchangeWorker Linux DebugGame  $$args
InterchangeWorker-Linux-Shipping.commands = $$build InterchangeWorker Linux Shipping  $$args
InterchangeWorker-Linux-Test.commands = $$build InterchangeWorker Linux Test  $$args
InterchangeWorker.commands = $$build InterchangeWorker Linux Development  $$args
...
UnrealObjectPtrTool-Linux-Debug.commands = $$build UnrealObjectPtrTool Linux Debug  $$args
UnrealObjectPtrTool-Linux-DebugGame.commands = $$build UnrealObjectPtrTool Linux DebugGame  $$args
UnrealObjectPtrTool-Linux-Shipping.commands = $$build UnrealObjectPtrTool Linux Shipping  $$args
UnrealObjectPtrTool-Linux-Test.commands = $$build UnrealObjectPtrTool Linux Test  $$args
UnrealObjectPtrTool.commands = $$build UnrealObjectPtrTool Linux Development  $$args
...
TextureShareSDK_D3D11-Linux-Debug.commands = $$build TextureShareSDK_D3D11 Linux Debug  $$args
TextureShareSDK_D3D11-Linux-DebugGame.commands = $$build TextureShareSDK_D3D11 Linux DebugGame  $$args
TextureShareSDK_D3D11-Linux-Shipping.commands = $$build TextureShareSDK_D3D11 Linux Shipping  $$args
TextureShareSDK_D3D11-Linux-Test.commands = $$build TextureShareSDK_D3D11 Linux Test  $$args
TextureShareSDK_D3D11.commands = $$build TextureShareSDK_D3D11 Linux Development  $$args

TextureShareSDK_D3D12-Linux-Debug.commands = $$build TextureShareSDK_D3D12 Linux Debug  $$args
TextureShareSDK_D3D12-Linux-DebugGame.commands = $$build TextureShareSDK_D3D12 Linux DebugGame  $$args
TextureShareSDK_D3D12-Linux-Shipping.commands = $$build TextureShareSDK_D3D12 Linux Shipping  $$args
TextureShareSDK_D3D12-Linux-Test.commands = $$build TextureShareSDK_D3D12 Linux Test  $$args
TextureShareSDK_D3D12.commands = $$build TextureShareSDK_D3D12 Linux Development  $$args
...
UnrealClient-Linux-Debug.commands = $$build UnrealClient Linux Debug  $$args
UnrealClient-Linux-DebugGame.commands = $$build UnrealClient Linux DebugGame  $$args
UnrealClient-Linux-Shipping.commands = $$build UnrealClient Linux Shipping  $$args
UnrealClient-Linux-Test.commands = $$build UnrealClient Linux Test  $$args
UnrealClient.commands = $$build UnrealClient Linux Development  $$args

UnrealEditor-Linux-Debug.commands = $$build UnrealEditor Linux Debug  $$args
UnrealEditor-Linux-DebugGame.commands = $$build UnrealEditor Linux DebugGame  $$args
UnrealEditor-Linux-Shipping.commands = $$build UnrealEditor Linux Shipping  $$args
UnrealEditor-Linux-Test.commands = $$build UnrealEditor Linux Test  $$args
UnrealEditor.commands = $$build UnrealEditor Linux Development  $$args

UnrealGame-Linux-Debug.commands = $$build UnrealGame Linux Debug  $$args
UnrealGame-Linux-DebugGame.commands = $$build UnrealGame Linux DebugGame  $$args
UnrealGame-Linux-Shipping.commands = $$build UnrealGame Linux Shipping  $$args
UnrealGame-Linux-Test.commands = $$build UnrealGame Linux Test  $$args
UnrealGame.commands = $$build UnrealGame Linux Development  $$args

UnrealServer-Linux-Debug.commands = $$build UnrealServer Linux Debug  $$args
UnrealServer-Linux-DebugGame.commands = $$build UnrealServer Linux DebugGame  $$args
UnrealServer-Linux-Shipping.commands = $$build UnrealServer Linux Shipping  $$args
UnrealServer-Linux-Test.commands = $$build UnrealServer Linux Test  $$args
UnrealServer.commands = $$build UnrealServer Linux Development  $$args

Building_Escape_3-Linux-Debug.commands = $$build Building_Escape_3 Linux Debug  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3-Linux-DebugGame.commands = $$build Building_Escape_3 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3-Linux-Shipping.commands = $$build Building_Escape_3 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3-Linux-Test.commands = $$build Building_Escape_3 Linux Test  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3.commands = $$build Building_Escape_3 Linux Development  -project="\"$$gameProjectFile\"" $$args

Building_Escape_3Editor-Linux-Debug.commands = $$build Building_Escape_3Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3Editor-Linux-DebugGame.commands = $$build Building_Escape_3Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3Editor-Linux-Shipping.commands = $$build Building_Escape_3Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3Editor-Linux-Test.commands = $$build Building_Escape_3Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
Building_Escape_3Editor.commands = $$build Building_Escape_3Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
